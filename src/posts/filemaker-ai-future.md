...
I recorded a quick walkthrough showing this setup with Claude, including how it works from desktop, web, and mobile: [watch the FM Dojo AI Data Access video](https://youtu.be/jdPd_RxSDEY?si=fZ0foJKNolJ9_O6d).
...
**FM Dojo** (https://fmdojo.com) is purpose-built AI tooling that grew out of requests I kept hearing from the FileMaker community. I built it from more than 30 years of FileMaker experience, including time at Claris (Apple), Lawrence Livermore National Laboratory, and Soliant Consulting. FM Dojo is an AI-powered development assistant designed specifically for the FileMaker platform.
